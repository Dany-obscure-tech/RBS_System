...
public class Item_history {
    ...
    public void sixValues(String itemId, String pushId, String shopkeeper_name,String shopkeeper_keyId, String shopkeeper_image, String rbs, String timestamp, String date){
    ...
    public void elevenValues(String itemId, String pushId, String shopkeeper_name,String shopkeeper_keyId, String shopkeeper_image, String shopkeeper_type, String customer_name,String customer_keyId, String customer_type, String customer_image, String rbs, String timestamp, String date){
        itemHistoryRef.child(itemId).child(pushId).child("Shopkeeper_name").setValue(shopkeeper_name);
        itemHistoryRef.child(itemId).child(pushId).child("Shopkeeper_keyId").setValue(shopkeeper_keyId);
