...
public class AdapterRBSGalleryItemListRecyclerView extends  RecyclerView.Adapter<AdapterRBSGalleryItemListRecyclerView.MyViewHolder> {
    ...
    public AdapterRBSGalleryItemListRecyclerView(Context context, List<String> itemname, List<String> price, List<String> itemImage, List<String> key_idList, List<String> categoryList, List<String> shopkeeperList) {
