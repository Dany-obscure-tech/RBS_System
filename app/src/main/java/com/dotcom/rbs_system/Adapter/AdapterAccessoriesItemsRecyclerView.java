...
public class AdapterAccessoriesItemsRecyclerView extends RecyclerView.Adapter<AdapterAccessoriesItemsRecyclerView.ViewHolder> {
    ...
    public AdapterAccessoriesItemsRecyclerView(Context context, List<String> purchaseItemNameList, List<String> purchaseCategoryList, List<String> purchasePriceUnitList, List<String> purchaseQuantityList) {
