...
public class AdapterAccessoriesItemDetailRecyclerView1 extends RecyclerView.Adapter<AdapterAccessoriesItemDetailRecyclerView1.ViewHolder> {
    Context context;
    List<String> itemCategoryList,ItemNameList,itemPriceList,itemQuantityList;

    public AdapterAccessoriesItemDetailRecyclerView1(Context context, List<String> itemCategoryList, List<String> ItemNameList, List<String> itemPriceList, List<String> itemQuantityList) {
    ...
    @NonNull
    @Override
    public AdapterAccessoriesItemDetailRecyclerView1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterAccessoriesItemDetailRecyclerView1.ViewHolder holder, final int position) {
