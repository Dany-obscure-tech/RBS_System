...
public class AdapterAccessoriesItemDetailRecyclerView extends RecyclerView.Adapter<AdapterAccessoriesItemDetailRecyclerView.ViewHolder> {
    Context context;
    List<String> itemCategoryList,ItemNameList,itemPriceList,itemQuantityList;

    public AdapterAccessoriesItemDetailRecyclerView(Context context,List<String> itemCategoryList,List<String> ItemNameList,List<String> itemPriceList,List<String> itemQuantityList) {
    ...
    @NonNull
    @Override
    public AdapterAccessoriesItemDetailRecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterAccessoriesItemDetailRecyclerView.ViewHolder holder, final int position) {
