...
public class PasscodeActivity extends AppCompatActivity {
    ...
    private void Initialize() {
        ...
        btn_1_button = (Button) findViewById(R.id.btn_1_button);
        btn_2_button = (Button) findViewById(R.id.btn_2_button);
        btn_3_button = (Button) findViewById(R.id.btn_3_button);
        btn_4_button = (Button) findViewById(R.id.btn_4_button);
        btn_5_button = (Button) findViewById(R.id.btn_5_button);
        btn_6_button = (Button) findViewById(R.id.btn_6_button);
        btn_7_button = (Button) findViewById(R.id.btn_7_button);
        btn_8_button = (Button) findViewById(R.id.btn_8_button);
        btn_9_button = (Button) findViewById(R.id.btn_9_button);
        btn_0_button = (Button) findViewById(R.id.btn_0_button);
        pincode_circle_1_imageview = (ImageView) findViewById(R.id.pincode_circle_1_imageview);
        pincode_circle_2_imageview = (ImageView) findViewById(R.id.pincode_circle_2_imageview);
        pincode_circle_3_imageview = (ImageView) findViewById(R.id.pincode_circle_3_imageview);
        pincode_circle_4_imageview = (ImageView) findViewById(R.id.pincode_circle_4_imageview);
        clear_imagebutton = (ImageButton) findViewById(R.id.clear_imagebutton);
        submit_imagebutton = (ImageButton) findViewById(R.id.submit_imagebutton);
