...
public class Add_Customer extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        adapterItemDetailsImagesRecyclerView = new AdapterItemDetailsImagesRecyclerView(Add_Customer.this, imageUrlList);
    ...
    private void onClickListeners() {
        ...
        uploadId_textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imageUrlList.size() < 2) {
                    ImagePicker.Companion.with(Add_Customer.this)
                            .crop()                    //Crop image(Optional), Check Customization for more option
                            .compress(1024)            //Final image size will be less than 1 MB(Optional)
                            .maxResultSize(1080, 1080)    //Final image resolution will be less than 1080 x 1080(Optional)
                            .start();
                } else {
                    Toast.makeText(Add_Customer.this, "Maximum 2 images allowed!", Toast.LENGTH_SHORT).show();
                }
        ...
        date_textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Add_Customer.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, onDateSetListener, year, month, day);
    ...
    private void checkPostcode() {
        ...
        latLng = getLocationFromAddress(Add_Customer.this, postcode);
    ...
    private void detailsSubmit() {
        pd.showProgressBar(Add_Customer.this);
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            pass_back_data();
            pd.dismissProgressBar(Add_Customer.this);
            finish();
