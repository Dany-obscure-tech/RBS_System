...
public class Rbs_vendor_specific_order extends AppCompatActivity {
    ...
    private void initialization() {
        ...
        invoice_no_textView = findViewById(R.id.invoice_no_textView);
        shopkeeper_order_details_recyclerview = findViewById(R.id.shopkeeper_order_details_recyclerview);
        shopkeeper_name_textView = findViewById(R.id.shopkeeper_name_textView);
        shopkeeper_phone_no_textView = findViewById(R.id.shopkeeper_phone_no_textView);
        shopkeeper_email_textView = findViewById(R.id.shopkeeper_email_textView);
        shopkeeper_address_textView = findViewById(R.id.shopkeeper_address_textView);
        ...
        placeorder_item_currency_textview = new ArrayList<>();
        place_order_price_textview = new ArrayList<>();
        place_order_quantity_textView = new ArrayList<>();
        requiredQuantity_editText = new ArrayList<>();
